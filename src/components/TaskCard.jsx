...
function TaskCard({titulo, categoria, prioridade}){
    return(
        <article className="bg-white rounded-x1 shadow-md p-5 hover:shadow-lg transition-shadow border border-slate-100">
            <div className="flex items-center justify-between mb-3">
                <span className="text-xs uppercase tracing-wide text-slate-400 font-semibold">
                    {categoria}
                </span>
