...
function TaskForm({ onAdicionar }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block text-sm font-semibold text-slate-600 mb-1" htmlFor="campo-categoria">
          Categoria
        </label>
        <select
          id="campo-categoria"
      ...
      <div>
        <label className="block text-sm font-semibold text-slate-600 mb-1" htmlFor="campo-prioridade">
          Prioridade
        </label>
        <select
          id="campo-prioridade"
